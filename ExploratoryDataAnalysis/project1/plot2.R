...
png(filename="~/Desktop/Coursera/ExploratoryDataAnalysis/project1/plot2.png",height=480,width=480,bg="white")
plot2=with(alldata,plot(datetime,Global_active_power,type="l",ylab="Global Active Power (kilowatts)",xlab=""))
dev.off()